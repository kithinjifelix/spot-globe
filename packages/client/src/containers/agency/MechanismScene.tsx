...
const url = `https://${window.location.hostname}:4701/api/v1/practices/mechanisms/`;
const agenciesUrl = `https://${window.location.hostname}:4701/api/v1/practices/agencies/`;
